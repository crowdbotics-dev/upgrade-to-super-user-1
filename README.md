...
## Project Structure
    ...
    ├── upgrade_to_super_user_1  # Django project configurations
...
1. Clone this repo and `cd upgrade_to_super_user_1`
...
2. Clone this repo and `cd upgrade_to_super_user_1`
